...
export const definitionMocks: DictionaryEntry = {
    "word": "table",
    "phonetics": [
        {
            "audio": "https://api.dictionaryapi.dev/media/pronunciations/en/table-au.mp3",
        ...
        {
            "text": "/ˈteɪbəl/",
            "audio": "https://api.dictionaryapi.dev/media/pronunciations/en/table-uk.mp3",
